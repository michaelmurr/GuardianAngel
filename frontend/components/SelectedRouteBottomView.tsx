...
const SelectedRouteBottomView = ({ expandSheet, members, street, setStreet, housenr, setHousenr, city, setCity, postalcode, setPostalcode, setShowSelectRoute, setDestination, collapseSheet, getToken }) => {
        ...
        return (
                ...
                <BottomSheetView style={styles.contentContainer}>
                        <YStack px="$4" gap={"$4"}>
                                <BottomSheetHeader title={'Select your destination'} members={members} expandSheet={expandSheet} />
