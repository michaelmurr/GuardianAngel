...
class GeoService:
    ...
    def calculate_corridor_from_route(
        ...
        line_m = transform(GeoService._to_m_transformer.transform, line)
    ...
    def calculate_finish_from_location(
        ...
        dest_point_m = GeoService.calculate_point_from_location(destination)
    ...
    def calculate_point_from_location(location: Location):
        ...
        point_m = transform(GeoService._to_m_transformer.transform, point)
        return point_m
    ...
    def corridor_to_geojson(corridor_geom: Polygon):
        ...
        corridor_wgs = transform(
            GeoService._to_deg_transformer.transform, corridor_geom
        )
